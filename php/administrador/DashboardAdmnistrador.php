...
function performGlobalSearch(query) {
    try {
        ...
        // Aquí se podría agregar más lógica de búsqueda
        
        // Si hay resultados, destacar los elementos encontrados
        if (resultados.length > 0) {
            resultados.forEach(resultado => {
                resultado.elemento.classList.add('bg-yellow-100', 'dark:bg-yellow-900/20');
            });
        }
    } catch (error) {
