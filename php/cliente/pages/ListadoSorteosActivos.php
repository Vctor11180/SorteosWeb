...
async function loadSorteosFromAPI() {
    try {
        ...
        const response = await fetch('../api/api_sorteos.php?action=list_active');
...
async function searchSorteosAPI(query) {
    try {
        const response = await fetch(`../api/api_sorteos.php?action=list_active&search=${encodeURIComponent(query)}`);
