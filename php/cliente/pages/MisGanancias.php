...
if (in_array('MisGanancias', $protectedPages) && (!isset($_SESSION['is_logged_in']) || $_SESSION['is_logged_in'] !== true)) {
            ...
            theme: {
                extend: {
                    colors: {
                        ...
                        "background-dark": "#111318", // Darker background to match request
                        "surface-dark": "#1c1f27", // Slightly lighter for cards
                        "surface-highlight": "#282d39", // For hover or active states
                        "success": "#22c55e",
                        "warning": "#eab308",
                    },
                    fontFamily: {
                ...
                button._reclamarHandler = function (e) {
                    ...
                    customConfirm(`¿Deseas reclamar el premio "${premioName}" del sorteo "${sorteoName}"?\n\nFecha ganada: ${fecha}\n${ticketNumber}\n\nAl confirmar, se enviará una solicitud oficial a la administración. Asegúrate de tener tus datos de contacto actualizados en tu perfil.`, 'Reclamar Premio', 'help').then(confirmed => {
                        if (confirmed) {
                            ...
                            fetch('../api/api_ganancias.php?action=reclamar', {
                                method: 'POST',
                                headers: {
